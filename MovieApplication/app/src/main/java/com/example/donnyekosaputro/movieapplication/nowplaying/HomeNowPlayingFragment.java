package com.example.donnyekosaputro.movieapplication.nowplaying;
...
public class HomeNowPlayingFragment extends Fragment {
    ...
    private static final String APIURL= BuildConfig.MOVIEURL+"/now_playing?api_key="+ BuildConfig.MOVIEAPIKEY+"&language=en-US";
